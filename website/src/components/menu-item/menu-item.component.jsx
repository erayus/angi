...
const MenuItem = ({itemImg, itemName, itemIngredients}) => {
    const noOfDisplayingIngredientItems  = 2;
    const noOfMoreThanTwo = itemIngredients.length > noOfDisplayingIngredientItems ? itemIngredients.length - 2 : 0; //TODO: better name?
          ...
          <MDBRow className='g-0'>
            ...
            <MDBCol size="8">
              <MDBCardBody style={{padding: '10px'}}>
                ...
                {
                    itemIngredients.slice().splice(0,2).map(itemIngredient => {
                        return (
